%
% eegplotg() - display EEG data in a clinical format
%
% >> eegplotg('dataname', samplerate, 'chanfile', 'title', yscaling, range)
%
...
%                                        (0 -> channel numbers)
% 'title'      : plot title string       (0 -> 'eegplotg()')
% yscaling     : initial y scaling factor (0 - default is 300)
% range        : how many seconds to display in window (0 -> 10)
%
% Note: this version of eegplot() reguires that your data matrix 
%       be defined as a global variable before running this routine. 
%       With long data sets, it may run much faster than eegplot()
%
%   Example:  >> global dataname
%             >> eegplotg('dataname')


% Written by Colin Humphries, CNL Salk Insitute 3/97 as eegplotgv.m
% 4-4-97 shortened name to eegplotg() -sm
% 5-20-97 added read of icadefs.m for MAXEEGPLOTCHANS -sm
% 8-10-97 Clarified chanfile type -sm

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function y = eegplot(dataname, samplerate, channamefile, titleval, yscaling, range)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   set(gcf,'Name',['EEGPLOT #',num2str(gcf)])
