...
%   ELSE     = [-n], the number largest-component maps to plot {default 7}
...
function [compvarorder,compvars,compframes,comptimes,compsplotted] = envtopo(data,weights,chan_file,limits,compnums,titl,plotchans,voffsets,colorfile,fill_comp_env,vert)
