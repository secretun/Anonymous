...
% Usage:
%    >> topoimage(data,'chan_locs',times,limits);
% OR >> topoimage(data,[rows cols],times,limits);
...
LINEWIDTH = 2.0;
YVAL = 10;          % plot horizontal lines at 10 Hz (rm comment to plot)
